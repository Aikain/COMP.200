...
\end{enumerate}
in the different citation styles. It is preferable to order the list of references alphabetically by the first author's last name. This template conforms automatically to this convention. An excellent way for the easy formation of citation entries is to find a template using Google Scholar. It produces a good first try for the use of Bib\TeX{} and Bib\LaTeX{}. In addition to the documentation,  provides a good summary of the different citation types and their associated fields.